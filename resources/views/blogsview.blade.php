        ...
        <div class="container mx-6 mx-sm-none">
            <div class="card mb-3" style="width: 100%;">
                ...
                <div class="card-header d-flex" style="width: 100%;">
                    ...
                    <div class="ms-auto">
                        <button type="button" id="new_blog" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#form_modal"> 
                                            ...
                                            <div class="card-body blog" data-id="{{$blog->blog_id}}">
                                                <div class="row justify-content-between">
                                                    <div class="col-md-9 col-9">                                            
                                                        <a href="{{route('blog.show-content',['id'=>$blog->blog_id])}}" target="blank" class="blog-title"><h3 class="card-title">{!!$blog->title!!}</h3></a>
                                                    </div>
                                                ...
                                                <img src="{{asset('storage/images/blogs/'.$blog->photo)}}" alt="" class="img-fluid blog-image my-1 p-2">
                                                ...
                                                <div class="row justify-content-between mt-2 blog-action">
                                                    ...
                                                    <div class="col-md-4 col-4 text-md-end blog-btns">
                                                        ...
                                                        @endcan
                                                        <a href="{{route('blog.show-content',['id'=>$blog->blog_id])}}" target="blank" class="comment-btn"><i class="fa-regular fa-comment"></i></a>
                        ...
                        <div class="modal-body">
                            <form action="" method="POST" id="post_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="content_post" name="content" class="form-control" style="height:30vh !important; resize:none;" autocomplete="off" placeholder="Your content goes here" rows=20></textarea>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="POST" id="update_form" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Title <i class="text-danger">*</i></label>
                                    <input type="text" id="title_update" name="title" class="form-control" maxlength="100" autocomplete="off" placeholder="Blog Title">
                                    <div id="title_error_message" class="text-danger"></div>
                                    @error('title')
                                    <div id="title_error_message" class="text-danger">{{$message}}</div>
                                    @enderror
                                ...
                                <div class="edit-image">
                                    <label>Add/Edit Image</label>
                                    <br>
                                    <img class="blog-image img-fluid d-none" id="blogImageUpdate" src="" alt="Blog Image" />
                                    <input type="hidden" id="imageURL" name="photoCopy">
                                    <input type="file" id="fileUpdate" name="photo" style="display:none;" accept=".jpg, .jpeg, .png">
                                    <br>
                                ...
                                <div class="form-group">
                                    <label>Content <i class="text-danger">*</i></label>
                                    <textarea id="content_update" name="content" class="form-control" style="height:30vh !important; resize:none;" autocomplete="off" placeholder="Your content goes here" rows=20></textarea>
                                    <div id="content_error_message" class="text-danger"></div>
                                    @error('content')
                                    <div id="content_error_message" class="text-danger">{{$message}}</div>
                                    @enderror
                ...
                $('body').on('click', '.update-btn', function(event) {
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            $('#update-id').val(id);
                            var blog=data.blog;
                            var imageURL="{{asset('storage/images/blogs/:photo')}}".replace(':photo',blog.photo);
                            $('#title_update').val(blog.title);
                            $('#imageURL').val(blog.photo);
                            blogImage.attr('src', imageURL).removeClass('d-none').addClass('d-block');
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            if(deletedElement.length>0){
                                ...
                                deletedElement.closest('.blog-container').removeClass('d-block').addClass('d-none');
                ...
                $('#post_form').submit(function(event){
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            var blogRoute = "{{ route('blog.show-content', ['id' => ':blogId']) }}".replace(':blogId', blog.blog_id);
                                ...
                                $.ajax({
                                    ...
                                    success: function(data){
                                        ...
                                        if(data.result){
                                            ...
                                            `;
                                            $(".action-header-"+blog.blog_id).append(actionHtml);
                                        }
                                    },
                                    error: function (xhr, status, error) {
                                        console.log('Error:', xhr.responseText);
                    ...
                    if(current<last){
                        ...
                        success: function(data){
                            ...
                            blogs.forEach(function(blog) {
                                ...
                                var blogRoute = "{{ route('blog.show-content', ['id' => ':blogId']) }}".replace(':blogId', blog.blog_id);
                                var image = '{{ asset("storage/images/blogs") }}'+'/'+blog.photo;
                                var duplicateElement=$('[data-id="' + blog.blog_id + '"].blog');
                                if(duplicateElement.length<=0){
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(data){
                                            ...
                                            if(data.result){
                                                $(".blog-btns-"+blog.blog_id).children('.like-btn').children('i').removeClass('fa-regular').addClass('fa-solid');
                                            }
