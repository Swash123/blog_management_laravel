        ...
        <div class="container mx-6 mx-sm-none">
            <div class="card mb-3" style="width: 100%;">
                ...
                <div class="card-header" style="width: 100%;">
                    <i class="fa-solid fa-blog"></i>&nbsp;Trending
                                            ...
                                            <div class="card-body blog" data-id="{{$blog->blog_id}}">
                                                <div class="row justify-content-between">
                                                    <div class="col-md-9 col-9">                                            
                                                        <a href="{{route('blog.show-content',['id'=>$blog->blog_id])}}" target="blank" class="blog-title"><h4 class="card-title">{!!$blog->title!!}</h4></a>
                                                    </div>
                                                ...
                                                <div class="row justify-content-between mt-2 blog-action">
                                                    <div class="col-md-8 col-8 text-muted status">
                                                        {{$blog->views.' views'}}<span class="mx-1">&bullet;</span>{{$blog->likes.' likes '}} {{$blog->total_interactions}}
                                                    </div>  
                    ...
                    var id=$(this).closest('.blog').data(id).id;
                        ...
                        $.ajax({
                            ...
                            success: function(data){
                                ...
                                status.html(interaction.views+' views.'+interaction.likes+' likes');
                            },
                            error: function (xhr, status, error) {
                                console.log('Error:', xhr.responseText);
                            }
